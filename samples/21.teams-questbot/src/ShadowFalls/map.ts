...
export const map: IMap = {
    locations: {
        village: {
            ...
            name: 'Shadow Falls',
            description:
                'A bustling settlement of small homes and shops, the Village of Shadow Falls is a friendly and welcoming place.',
        ...
        forest: {
            ...
            description:
                'The ancient forest of Shadowwood is a sprawling wilderness full of tall trees and thick foliage.',
        ...
        river: {
            ...
            description:
                'A winding and treacherous path, the Shadow Falls River is a source of food for the villagers and home to dangerous creatures.',
        ...
        mountains: {
            ...
            description:
                'The Shadow Mountains are a rugged and dangerous land, rumored to be home to dragons and other mythical creatures.',
        ...
        canyon: {
            ...
            name: 'Shadow Canyon',
            description:
                'Shadow Canyon is a deep and treacherous ravine, the walls are steep and jagged, and secrets are hidden within.',
        ...
        lake: {
            ...
            description:
                'Shadow Falls Lake is a peaceful and serene body of water, home to a booming fishing and logging industry.',
        ...
        swamp: {
            ...
            name: 'Shadow Swamp',
            description:
                'Shadow Swamp is a murky and treacherous marsh, home to some of the most dangerous creatures in the region.',
        ...
        oasis: {
            ...
            description:
                'The Oasis of the Lost is a lush and vibrant paradise, full of exotic flowers and the sweet smell of coconut.',
        ...
        valley: {
            ...
            description:
                'The Valley of the Anasazi is a mysterious and uncharted land, home to the ruins of forgotten temples.',
        ...
        temple: {
            ...
            name: 'Anasazi Temple',
            description:
                'The abandoned Anasazi Temple is a forgotten and crumbling ruin, its walls covered in vines and ancient symbols.',
        ...
        cave: {
            ...
            description:
                'The Cave of the Ancients is a hidden and treacherous place, filled with strange echoes and whispers.',
        ...
        pyramids: {
            ...
            description:
                'The ancient Pyramids of the Forgotten, built by the Anuket, are home to powerful magic, guarded by ancient and powerful creatures.',
