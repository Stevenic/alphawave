...
export const quests: IQuest[] = [
    {
        ...
        description: `Long ago, in a forgotten age, an ancient evil was unleashed upon the land. The powerful entity cursed the surrounding area, transforming it into a dank and dangerous dungeon filled with powerful monsters and treacherous traps. Now, brave adventurers must venture into the depths of the Dungeon of Shadow Falls to rid the land of the curse and restore peace to the realm. Will you accept the challenge?`,
    },
    {
        title: `The Artifact of Shadow Falls`,
        description: `A powerful magical artifact lies hidden within the treacherous Valley of Shadow Falls. It is said to hold the key to great power and knowledge, but it has been guarded by an ancient guardian for centuries. A group of adventurers set off in search of the relic, but never returned. The villagers of Shadow Falls have asked the party to undertake a daring rescue mission and save the lost adventurers from their certain doom.`,
    }
];
